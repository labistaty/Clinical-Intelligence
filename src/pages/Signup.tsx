...
import { User, Mail, Lock, ArrowRight, Loader2, BrainCircuit, ShieldCheck } from 'lucide-react';
...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setError('Traditional signup is currently disabled. Please use Google to create your clinical account.');
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-container-lowest px-6 py-12">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-headline font-extrabold text-on-surface tracking-tight">Create Account</h1>
          <p className="text-on-surface-variant mt-2">Join the next generation of clinical intelligence</p>
        </div>
        ...
        <div className="bg-white p-8 rounded-[2.5rem] clinical-shadow border border-outline-variant/10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant px-1">Password</label>
              <div className="relative">
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-widest">
              <span className="bg-white px-4 text-on-surface-variant font-bold">Or sign up with</span>
            </div>
          </div>
